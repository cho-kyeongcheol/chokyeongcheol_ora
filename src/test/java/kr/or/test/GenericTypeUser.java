...
public class GenericTypeUser {
	...
	public static void main(String[] args) {
		...
		System.out.println("입력된 name변수의 키 : " + nameK);
		System.out.println("입력된 name변수의 값 : " + nameV);
		...
		System.out.println("아이디는 " + tableKV.get("userid")) ;
		System.out.println("비밀번호는 " + tableKV.get("userpw"));
		System.out.println("이름은 " + tableKV.get("username"));		

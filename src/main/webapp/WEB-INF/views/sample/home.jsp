...
<meta charset="UTF-8">
<meta name="viewport"
	content="wth=device-wth, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scaleable=no">
<title>HOME</title>
	...
	<div ="wrap">
		...
		<section class="content"> 
			...
			<section class="promotion-section">
				<div class="container">
					<ul class="promo-list">
						<li><a href="#" onclick="return false"> <img src="/resources/images/kakao.jpg"
								alt="">
								<h3>HOME</h3>
				...
				<form action="" method="">
					<fieldset class="cfixed">
						...
						<div class="form">
							...
							<label for="phone"
								class="blind">phone</label> <input type="tel" ="phone"

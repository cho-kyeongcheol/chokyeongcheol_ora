  ...
  <link href="/resources/css/nivo-slider.css" media="screen" rel="stylesheet" type="text/css">
	...
	<section class="banner_slider">
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<!-- <a class="left carousel-control" style="font-size:40px;font-weight:bold;" href="#carouselExampleIndicators" data-slide="prev"
	...
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/kakao.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/kakao.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/kakao.jpg" alt=""
				...
				<li class="col-6 last"><img src="/resources/images/kakao.jpg"

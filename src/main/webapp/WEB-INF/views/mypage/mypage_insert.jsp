    ...
    <div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">회원 <span class="path">/</span> 마이페이지</p>
						...
						<fieldset>
							...
							<ul class="reg_list">
								...
								<li class="clear">
									...
									<div class="reg_content" style="padding-top:8px;">
									<input value="" name="user_pw" type="password" class="w100p" id="name_pw_lbl" placeholder="암호를 입력해주세요"/>
								</div>
								</li>
								...
								<li class="clear">
									...
									<div class="reg_content" style="padding-top:8px;">
									<input required value="${memberVO.user_name}" name="user_name" type="text" class="w100p" id="name_pw_lbl" />
								</div>
								</li>								
								<li class="clear">
									<label class="tit_lbl">이메일</label>
									<div class="reg_content" style="padding-top:8px;">
									<input value="${memberVO.email}" name="email" type="text" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
								</div>
								</li>
								
									<input value="0" name="point" type="hidden" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
									<input value="1" name="enabled" type="hidden" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
									<input value="ROLE_USER" name="levels" type="hidden" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
	...
	$(document).ready(function(){
		$('#user_id').blur(function(){
			...
			$.ajax({
				...
				error:function(){
				alert("아이디체크 RestApiㅅ버가 작동하지 않습니다.");	
				}

						...
						<fieldset>
							...
							<ul class="reg_list">
								...
								<li class="clear">
									...
									<div class="reg_content">
									<input value="${memberVO.user_name}" name="user_name" type="text" class="w100p" id="name_pw_lbl" />
								</div>
								</li>								
								<li class="clear">
								...
								<li class="clear">
									...
									<div class="reg_content">
									${memberVO.point}
									<input value="${memberVO.point}" name="point" type="hidden" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
								</div>
								</li>
								<li class="clear">
									...
									<div class="reg_content">
									${memberVO.enabled}
									<input value="${memberVO.enabled}" name="enabled" type="hidden" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
								</div>
								</li>
								<li class="clear">
									...
									<div class="reg_content">
									${memberVO.levels}
									<input value="${memberVO.levels}" name="levels" type="hidden" class="w100p" id="name_pw_lbl" placeholder="이름을 입력해주세요"/>
								</div>
								</li>								
							</ul>
							<p class="btn_line">
